...
//           <Button variant="outline" size="lg" onClick={() => setOpenUpload(true)}>
...
import { Briefcase, Globe, MapPin, Pencil, Upload } from "lucide-react";
  ...
  return (
    <div className="h-full w-full bg-gradient-to-b from-background to-muted/30 px-6 py-10">
      <div className="flex flex-col items-center gap-6 border-b pb-8 sm:flex-row sm:items-start">
        ...
        <div className="flex gap-3 self-center sm:self-start">
          <Button variant={isEditing ? "secondary" : "default"} size="lg" onClick={() => setIsEditing((prev) => !prev)}>
            {isEditing ? "Cancel" : "Edit Profile"}
          </Button>

          <Button type="button" onClick={() => setOpenUpload(true)} variant="outline" size="lg">
